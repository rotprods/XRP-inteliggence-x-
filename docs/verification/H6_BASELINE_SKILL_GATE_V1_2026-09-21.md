...
- PR #21 exact head `c6b874ad50b25b256d64a8ea7f51739400354270` has FAST verification PASS.
- Branch `research/baseline-skill-gate-canonical-v1` was created directly from that exact green PR #21 head.
- PR #22 DatasetVersion remains a separate active scope. H6 binds to DatasetVersion only by content-addressed ID and does not duplicate PR #22 implementation.
